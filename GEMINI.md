...
Diese Datei wird von Gemini CLI / Code Assist automatisch als Kontext für alle Prompts in diesem Repository gelesen.
Speichere sie als `GEMINI.md` im Root jedes Repos.
