...
```
telegram/
├── 50_540_TELEGRAM_ASSISTANT.json
├── 50_541_WORKFLOW_CONTROL.json
├── 50_542_STATUS_REPORT.json
├── 50_543_RESEARCH_DATA.json
├── 50_550_JARVIS_APPROVAL_FLOW.json
├── 50_551_JARVIS_CALLBACK.json
├── SETUP.md
```
...
cd "/Users/zuhause_mit_ideen/projects/:new/0-prod-aios-monorepo/automations/n8n-workflows/telegram"
ls -la
```
