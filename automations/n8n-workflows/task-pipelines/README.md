...
```
task-pipelines/
├── coder-agent-workflow.json
├── voice-lead-generation.json
```
...
cd "/Users/zuhause_mit_ideen/projects/:new/0-prod-aios-monorepo/automations/n8n-workflows/task-pipelines"
ls -la
```
