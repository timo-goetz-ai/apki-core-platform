...
```
content-pipeline/
├── 40_30_CONTENT_IMAGE.json
├── 40_32_CONTENT_VOICE.json
├── 40_40_PUBLISH_SOCIAL.json
├── 40_410_PIXART_IMAGE.json
├── 40_41_PUBLISH_BLOG.json
├── 40_420_FISH_AUDIO.json
├── 40_435_WEEKLY_SUMMARY.json
├── 40_450_CONTENT_MASTER_FLOW_v2.json
├── 40_460_GDRIVE_SYNC.json
├── 40_480_BATCH_TRIGGER.json
```
...
cd "/Users/zuhause_mit_ideen/projects/:new/0-prod-aios-monorepo/automations/n8n-workflows/content-pipeline"
ls -la
```
