...
```
research/
├── 30_310_TREND_MONITOR.json
├── 30_340_NICHE_RESEARCH.json
├── 30_350_CONTENT_FORECAST.json
├── 30_360_DEEP_INSIGHTS.json
```
...
cd "/Users/zuhause_mit_ideen/projects/:new/0-prod-aios-monorepo/automations/n8n-workflows/research"
ls -la
```
