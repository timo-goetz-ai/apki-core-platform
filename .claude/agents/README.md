...
> Agenten, Prompts oder Orchestrierung — Konfiguration und Grenzen.

## 📋 Übersicht

Dieses Verzeichnis ist Teil des Repos unter `:new`. Die folgende Beschreibung wurde **automatisch aus Pfad und Namen** abgeleitet (Heuristik: `agents`) und soll Onboarding und Agenten-Kontext beschleunigen. Bei fachlicher Abweichung bitte **manuell anpassen**.

## 🎯 Zweck

- Tool-Use und Datenklassen gemäß Governance.
- Versionierte Prompts wie Code behandeln.
- Evaluierung und Feedback-Loops verlinken.
...
cd "/Users/zuhause_mit_ideen/projects/:new/0-prod-aios-monorepo/.claude/agents"
ls -la
```
...
*Hinweis:* Zweiter Block ist ein **lauffähiges Minimalbeispiel** (TypeScript), nicht notwendigerweise Teil dieses Ordners.
