...
> Arbeitsverzeichnis `.claude` — Inhalte dieses Ordners strukturieren und anbinden.

## 📋 Übersicht

Dieses Verzeichnis ist Teil des Repos unter `:new`. Die folgende Beschreibung wurde **automatisch aus Pfad und Namen** abgeleitet (Heuristik: `allgemein`) und soll Onboarding und Agenten-Kontext beschleunigen. Bei fachlicher Abweichung bitte **manuell anpassen**.

## 🎯 Zweck

- Zweck und Owner kurz festhalten.
- Nachbar-Ordner und Abhaengigkeiten verlinken.
- Änderungen in Changelog oder Tickets erwaehnen.
...
cd "/Users/zuhause_mit_ideen/projects/:new/0-prod-aios-monorepo/.claude"
ls -la
```
...
*Hinweis:* Zweiter Block ist ein **lauffähiges Minimalbeispiel** (Go), nicht notwendigerweise Teil dieses Ordners.
