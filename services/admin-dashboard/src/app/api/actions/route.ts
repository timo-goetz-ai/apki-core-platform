...
export const COMMAND_REGISTRY: CommandDef[] = [
  // Navigation
  { intent: 'open_cockpit',         description: 'Open the main cockpit dashboard', category: 'navigation', navigate: '/' } as CommandDef & { navigate: string },
  { intent: 'open_claude_workspace',description: 'Open Claude AI workspace',        category: 'navigation', navigate: '/claude-workspace' } as CommandDef & { navigate: string },
  { intent: 'open_deployments',     description: 'Open deployments page',           category: 'navigation', navigate: '/deployments' } as CommandDef & { navigate: string },
  { intent: 'open_workflows',       description: 'Open n8n workflows',              category: 'navigation', navigate: '/workflows' } as CommandDef & { navigate: string },
  { intent: 'open_analytics',       description: 'Open analytics / Grafana',        category: 'navigation', navigate: '/analytics' } as CommandDef & { navigate: string },
